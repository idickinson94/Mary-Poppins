    ...
    <div className={styles.home_container}>
      ...
      <div className={styles.info}>
        ...
        <p>
          ...
          to life from the pages of books and mingle with the crowd. The
          festival honours the author of the Mary Poppins books, Pamela Lyndon
          Travers, who was born Helen Lyndon Goff in an upstairs bedroom of the
          former Australian Joint Stock Bank building in Maryborough on 9 August
          1899. The bank is now an interactive museum called the Story Bank of
          Maryborough, which will feature prominently in the festival.
        </p>
      </div>
